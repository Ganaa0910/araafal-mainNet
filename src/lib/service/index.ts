...
export async function fetchRaffles({
  ...
  const response = await axiosClient.get(
    `/api/mainNet/mainNet/mainNet/raffles?page=${pageParam}&limit=${limitParam}`,
  );
  const raffles = response?.data.data.data;
...
export async function fetchFeaturedRaffles(): Promise<Raffle[]> {
  return axiosClient.get(`/api/mainNet/mainNet/mainNet/raffles/featured`).then((response) => {
    return response?.data.data.data;
  });
}

export async function fetchRaffleById(id: string): Promise<Raffle> {
  return axiosClient.get(`/api/mainNet/mainNet/mainNet/raffles/${id}`).then((response) => {
    return response?.data.data.data;
  });
}
...
export async function getTicketsByUser(
  ...
  return axiosClient.get(`/api/mainNet/mainNet/mainNet/tickets/user/${id}`).then((response) => {
    return response?.data.data.data;
  });
}

export async function getUserRaffles(id: string): Promise<Raffle[]> {
  return axiosClient.get(`/api/mainNet/mainNet/mainNet/users/${id}/myRaffles`).then((response) => {
    return response?.data.data;
  });
}

export async function getTicketsByRaffle(id: string) {
  return axiosClient.get(`/api/mainNet/mainNet/raffles/${id}/tickets`).then((response) => {
    return response?.data.data;
  });
}
export async function getTicketsCountByRaffle(id: string) {
  return axiosClient
    .get(`/api/mainNet/mainNet/raffles/${id}/tickets/count`)
    .then((response) => {
      return response?.data.data;
    });
}
...
export async function getUserProfile(address: string): Promise<User> {
  return axiosClient.get(`/api/mainNet/mainNet/users/${address}/profile`).then((response) => {
    return response?.data.data;
  });
}

export async function getUserWonRaffles(id: string) {
  return axiosClient.get(`/api/mainNet/mainNet/users/${id}/wonRaffles`).then((response) => {
    return response?.data.data;
  });
}
...
export async function getUserParticipated(id: string) {
  return axiosClient
    .get(`/api/mainNet/mainNet/users/${id}/participatedRaffles`)
    .then((response) => {
      return response?.data.data;
    });
}
...
export async function getInscriptionsTestnet(
  ...
  return axiosClient
    .get(`/api/mainNet/mainNet/users/${address}/inscriptions`)
    .then((response) => {
      return response?.data.data;
    });
}
export async function decryptPrivateKeyNft(
  ...
  return axiosClient
    .post(`/api/mainNet/mainNet/raffles/decryptPrivateKey/${privateKey}/nft`)
    .then((response) => {
      return response?.data.data;
    });
}
export async function decryptPrivateKeyTicket(
  ...
  return axiosClient
    .post(`/api/mainNet/mainNet/raffles/decryptPrivateKey/${privateKey}/ticket`)
    .then((response) => {
      return response?.data.data;
    });
}
export async function getUserBRC20Balance(
  ...
  return axiosClient.get(`/api/mainNet/mainNet/users/${address}/brc20`).then((response) => {
    return response?.data.data;
  });
}
export async function getUserBitcoinBalance(address: string) {
  return axiosClient.get(`/api/mainNet/mainNet/users/${address}/bitcoin`).then((response) => {
    return response?.data.data;
  });
}
export async function getReferralCode(address: string) {
  return axiosClient.get(`/api/mainNet/mainNet/users/${address}/referral`).then((response) => {
    return response?.data.data;
  });
}
...
export async function getPosition(address: string) {
  return axiosClient
    .get(`/api/mainNet/mainNet/users/${address}/leaderboardPosition`)
    .then((response) => {
      return response?.data.data;
    });
}
...
export async function getLeaderboard(): Promise<LeaderboardEachUserType[]> {
  return axiosClient.get(`/api/mainNet/mainNet/leaderboard`).then((response) => {
    return response?.data.data;
  });
}
...
export async function createRaffle({
  ...
  try {
    return axiosClient.post(`/api/mainNet/mainNet/raffles`, newRaffleData).then((response) => {
      return response;
    });
  } catch (error) {
...
export async function createTicket({
  ...
  try {
    return axiosClient.post(`/api/mainNet/mainNet/tickets`, newTicketData).then((response) => {
      return response;
    });
  } catch (error) {
    console.log("Error:", error);
...
export async function createReferral() {
  try {
    return axiosClient.post(`/api/mainNet/mainNet/users/referral`).then((response) => {
      return response;
    });
  } catch (error) {
    console.log("Error:", error);
...
export async function createWalletForRaffle() {
  try {
    return axiosClient.post(`/api/mainNet/mainNet/raffles/generateWallet`).then((response) => {
      return response;
    });
  } catch (error) {
    console.log("Error:", error);
